...
def render():
    ...
    cards = ''.join([
        ...
        'it? Four levels: facts, rules and the search; lists and collecting '
        'answers; negation, the cut, operators and grammars; and exceptions, '
        'the database and I/O. Every query is one you run against this interpreter.</p></a>'
